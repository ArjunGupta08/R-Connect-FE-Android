...
class RatePlanChildAdapter(val list:ArrayList<String>, val applicationContext: Context):RecyclerView.Adapter<RatePlanChildAdapter.NotificationHolder>() {
...
//        val add = itemView.findViewById<ImageView>(R.id.addBaseAdult);
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotificationHolder {
        ...
        val view = inflater.inflate(R.layout.item_rate_plan_child,parent,false)
