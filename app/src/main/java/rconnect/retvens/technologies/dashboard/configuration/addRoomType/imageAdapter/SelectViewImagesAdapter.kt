...
class SelectViewImagesAdapter(val context: Context, private val itemList: ArrayList<SelectImagesDataClass>) : RecyclerView.Adapter<SelectViewImagesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (position < itemList.size) {
            ...
            holder.addImage.setOnClickListener {
                onItemClickListener?.onAddViewImage()
            }
        }
