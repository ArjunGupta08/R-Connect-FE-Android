...
class RatePlanCompanyDetailsAdapter(val applicationContext:Context, val rateTypeList:ArrayList<AddCompanyRatePlanDataClass>):RecyclerView.Adapter<RatePlanCompanyDetailsAdapter.ViewHolder>(){
