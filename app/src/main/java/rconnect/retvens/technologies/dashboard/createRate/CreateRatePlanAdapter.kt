...
class CreateRatePlanAdapter(val applicationContext:Context, val rateTypeList:ArrayList<CreateRateData>):RecyclerView.Adapter<CreateRatePlanAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.item_recycler_create_rate_plan,parent,false)
