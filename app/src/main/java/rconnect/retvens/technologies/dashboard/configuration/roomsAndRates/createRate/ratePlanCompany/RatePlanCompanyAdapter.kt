...
class RatePlanCompanyAdapter(
    val applicationContext:Context,
    val supportFragmentManager: androidx.fragment.app.FragmentManager,
    val rateTypeList:ArrayList<AddCompanyRatePlanDataClass>):RecyclerView.Adapter<RatePlanCompanyAdapter.ViewHolder>(){
    ...
    interface OnRateTypeListChangeListener {
        fun onRateTypeListChanged(updatedRateTypeList: ArrayList<AddCompanyRatePlanDataClass>, position: Int)
