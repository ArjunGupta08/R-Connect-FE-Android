...
class RoomTypePlan(val applicationContext:Context, val rateTypeList:ArrayList<GetInclusionsData>, val postingRuleArray:ArrayList<String>, val chargeRuleArray:ArrayList<String>):RecyclerView.Adapter<RoomTypePlan.ViewHolder>() {
