...
class DashboardActivity : AppCompatActivity() {
    ...
    lateinit var bindingMobile:ActivityDashboardMobileBinding
...
//        setContentView(binding.root)
            ...
            notificationList.add(
                NotificationData(
                    ...
                    "Karan Wants To Join Your Group ‘Salse Chat’",
                    "3 Hrs Ago"
                )
            )
            notificationList.add(
...
//                    replaceFragment(CreateRatePlanFragment())
        ...
        binding!!.billingsCard.setOnClickListener {
            ...
            if (!isBillingOpen) {
                ...
                binding!!.billingsCard.setCardBackgroundColor(
                    ContextCompat.getColor(
                        applicationContext,
                        R.color.white
                    )
                )
                binding!!.billingTxt.setTextColor(
                    ContextCompat.getColor(
                        applicationContext,
                        R.color.black
                    )
        ...
        binding!!.guestsCard.setOnClickListener {
            ...
            if (!isGuestOpen) {
                ...
                draw?.colorFilter = PorterDuffColorFilter(Color.BLACK, PorterDuff.Mode.SRC_ATOP)
                binding!!.guestsDropDown.setImageDrawable(draw)
                binding!!.guestsCard.setCardBackgroundColor(
                    ContextCompat.getColor(
                        applicationContext,
                        R.color.white
                    )
                )
                binding!!.guestsTxt.setTextColor(
                    ContextCompat.getColor(
                        applicationContext,
                        R.color.black
                    )
