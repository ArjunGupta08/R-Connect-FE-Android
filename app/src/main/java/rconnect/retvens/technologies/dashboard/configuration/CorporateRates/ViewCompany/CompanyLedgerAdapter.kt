...
class CompanyLedgerAdapter(val list:ArrayList<String>, val applicationContext: Context):RecyclerView.Adapter<CompanyLedgerAdapter.NotificationHolder>() {
...
//        val add = itemView.findViewById<ImageView>(R.id.addBaseAdult);
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotificationHolder {
        ...
        val view = inflater.inflate(R.layout.item_compny_ledger,parent,false)
