...
class SelectBedImagesAdapter(val context: Context, private val itemList: ArrayList<SelectImagesDataClass>) : RecyclerView.Adapter<SelectBedImagesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (position < itemList.size) {
            ...
            holder.addImage.setOnClickListener {
                onItemClickListener?.onAddBedImage()
            }
        }
